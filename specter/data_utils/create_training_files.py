...
class TrainingInstanceGenerator:
    ...
    def __init__(self,
        ...
        self.hard_citation = hard_citation
...
if __name__ == '__main__':
    ...
    ap.add_argument('--include-author-data', help='whether to include author samples or not', action='store_true',
                    default=False)
    ap.add_argument('--hard-citation', help='whether to include hard citation samples or not', action='store_true',
                    default=False)
    ap.add_argument('--hard-author', help='whether to include hard author samples or not', action='store_true',
                    default=False)
    ap.add_argument('--easy-citation', help='whether to include easy citation samples or not', action='store_true',
                    default=False)
